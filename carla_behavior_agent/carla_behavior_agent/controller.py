...
from math import atan2, atan, hypot, sin, cos
...
class StanleyLateralController():
    ...
    def _stanley_control(self, vehicle_transform):
        ...
        # Crosstrack error with offset
        # Adjust the desired position by adding the offset
        offset_x = -self._offset * sin(desired_heading)
        offset_y = self._offset * cos(desired_heading)
