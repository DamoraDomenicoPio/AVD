...
def get_stop_sign_trigger_location(stop_signal):
    """
    Calculates the yaw of the waypoint that represents the trigger volume of the traffic light
    """
    def rotate_point(point, radians):
    ...
    base_transform = stop_signal.get_transform()
    base_rot = base_transform.rotation.yaw
    area_loc = base_transform.transform(stop_signal.trigger_volume.location)
    area_ext = stop_signal.trigger_volume.extent
